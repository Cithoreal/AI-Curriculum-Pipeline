# From https://github.com/open-webui/pipelines/blob/main/examples/pipelines/events_pipeline.py
...
class Pipeline:
    def __init__(self):
        self.name = "Retrieve data from FastAPI"
        self.description = (
            "This is a pipeline that demonstrates how to use the status event."
        )
        self.debug = True
        self.version = "0.1.0"
        self.author = "Christopher DiCarlo"
    ...
    def pipe(
        ...
        response = requests.get("https://aiapi.cybernautics.net/api/get_today_logs", json=body)
